...
if ($global:CaritasOSDProgressStarted) { Update-OSDProgress -Phase 2 -Text 'Windows wird installiert...' }
Invoke-OSDCloud
...
#================================================
if ($global:CaritasOSDProgressStarted) { Update-OSDProgress -Phase 3 -Text 'Nachbereitung (Autopilot, Treiber, Apps)...' }
